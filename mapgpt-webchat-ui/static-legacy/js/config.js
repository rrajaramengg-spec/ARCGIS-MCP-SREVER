// ── MapGPT Configuration Constants ───────────────
...
// Source location symbol (analyze queries — geocode/coordinate origin)
...
// Proximity line symbol (dashed gray, thin)
export const PROXIMITY_LINE_SYMBOL = {
    type: 'simple-line',
...
// Pick-mode pin symbol (temporary marker for location picker)
export const PICK_PIN_SYMBOL = {
    type: 'simple-marker',
    color: [56, 168, 0],
    size: 12,
    outline: { color: [255, 255, 255], width: 2 }
